<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="compactSidebar">
        <ul class="menu-categories">
            <li class="menu active">
                <a href="#categories" data-active="true" class="menu-toggle">
                    <div class="base-menu">
            ...
            <li class="menu">
                <a href="#permissions" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="#assign" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="#coins" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="#arches" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
    ...
    <div id="compact_submenuSidebar" class="submenu-sidebar">
        ...
        <div class="submenu" id="categories">
            <ul class="submenu-list" data-parent-element="#categories"> 
                <li class="active">
        ...
        <div class="submenu" id="roles">
            <ul class="submenu-list" data-parent-element="#roles"> 
                <li>
        ...
        <div class="submenu" id="permissions">
            <ul class="submenu-list" data-parent-element="#permissions">
                <li>
        ...
        <div class="submenu" id="assign">
            <ul class="submenu-list" data-parent-element="#assign">
                <li>
        ...
        <div class="submenu" id="coins">
            <ul class="submenu-list" data-parent-element="#coins">
                <li>
        ...
        <div class="submenu" id="arches">
            <ul class="submenu-list" data-parent-element="#arches">
